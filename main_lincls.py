...
parser.add_argument('--lr', '--learning_rate', default=30., type=float, metavar='LR', help='initial learning rate',
                    dest='lr')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    valset = datasets.CIFAR10(args.data_root, train=False, transform=transform_test)

    if args.dataset == 'cifar10':
        train_set = cifar10Imbanlance.Cifar10Imbanlance(transform=transform_train, train=True,
        ...
        test_set = cifar10Imbanlance.Cifar10Imbanlance(imbanlance_rate=args.imbanlance_rate, train=False,
                                                       transform=transform_test, file_path=args.data_root)
        # test_set.data = test_set.data['x']
        print("load cifar10")

    if args.dataset == 'cifar100':
        train_set = cifar100Imbanlance.Cifar100Imbanlance(transform=transform_train, train=True,
                                                          imbanlance_rate=args.imbanlance_rate,
    ...
    if args.dataset == 'ImageNet-LT':
        train_set = dataset_lt_data.LT_Dataset(args.data_root, args.dir_train_txt, transform=transform_train)
        test_set = dataset_lt_data.LT_Dataset(args.data_root, args.dir_test_txt, transform=transform_test)
