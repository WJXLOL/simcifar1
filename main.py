...
parser.add_argument('--eval_freq', default=50, type=int, help='evaluate model frequency')
...
def main():
    ...
    if args.dataset == 'cifar10':
        ...
        test_set = cifar10Imbanlance.Cifar10Imbanlance(imbanlance_rate=args.imbanlance_rate, train=False,
                                                       transform=transform_val, file_path=args.data_root)
    ...
    if args.dataset == 'ImageNet-LT':
        train_set = dataset_lt_data.LT_Dataset(args.data_root, args.dir_train_txt,
                                               transform=util.TwoCropTransform(transform_train))
        test_set = dataset_lt_data.LT_Dataset(args.data_root, args.dir_test_txt, transform=transform_val)
